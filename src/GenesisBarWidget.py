from PySide6.QtWidgets import QWidget, QFrame, QVBoxLayout, QHBoxLayout, QScrollArea
...
class GenesisBarWidget(QWidget):
    def __init__(self, parent: QWidget, fishes: FishSchool):
        ...
        frame_layout.setAlignment(Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignTop)



        self.pie_chart = PieChartWidget(self, self.__fishes)
        ...
        scroll_area_content_layout.setAlignment(Qt.AlignmentFlag.AlignTop|Qt.AlignmentFlag.AlignLeft)
        scroll_area_content.setLayout(scroll_area_content_layout)
        scroll_area.setWidget(scroll_area_content)
        frame_layout.addWidget(scroll_area)


        self.pond_info = PondInfoWidget(self, config.POND_NAME, self.__fishes.get_population())
